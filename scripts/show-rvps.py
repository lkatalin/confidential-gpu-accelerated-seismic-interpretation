...
FIELDS = [
    ...
    },
    {
        ...
        "env_key": None,
        "note":    "not collected — update collect-tdx-measurements.sh to extract RTMR[0]",
    },
    {
        "name":    "rtmr_3",
        ...
        "env_key": None,
        "note":    "not collected — likely zero in kata-cc, low priority",
    },
    {
        "name":    "td_attributes",
        ...
        "env_key": None,
        "note":    "not collected — SECURITY: a debug TD is not truly confidential",
    },
    {
        "name":    "mr_seam",
        ...
        "env_key": None,
        "note":    "not collected — optional; pins exact Intel TDX module version",
    },
]
